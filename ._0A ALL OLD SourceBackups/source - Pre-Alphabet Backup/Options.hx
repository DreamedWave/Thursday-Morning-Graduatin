...
class FullscreenOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.fullscreen ? "Fullscreen: Yes" : "Fullscreen: No";
	}
}
...
class HighQualityNoteSplash extends Option
{
	...
	private override function updateDisplay():String
	{
		return "VFX Antialiasing: " + (!FlxG.save.data.hqnotesploosh ? "OFF" : "ON");
	}
}
...
class ShitBreaksCombo extends Option
{
	...
	private override function updateDisplay():String
		return "SLIPS Miss " + (FlxG.save.data.shitBreaksCombo ? "yes" : "no");
}
