	...
	override function update(elapsed)
	{
		...
		{			
			...
			else
			{
				...
				if (FlxG.keys.justPressed.ANY || FlxG.keys.justReleased.ANY || FlxG.mouse.justPressed || FlxG.mouse.justPressedMiddle || FlxG.mouse.justPressedRight || FlxG.mouse.justReleased || FlxG.mouse.justReleasedMiddle || FlxG.mouse.justReleasedRight)
					tipText.alpha = 1;
			}	
		}
	}
