...
class Note extends FlxSprite
{
	...
	public var tempRating:String = "sick"; //For sustain note ratings to be properly rated
	...
	public var parentWife:Float = 0;
	public var spotInLine:Int = 0;
	public var sustainActive:Bool = true;
	public var noteWasActive:Bool = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (!inCharter)
		{
			if (mustPress)
			{
				...
				if (!PlayState.instance.allowHealthModifiers && PlayState.instance.doLagComp && isOnScreen(PlayState.instance.camHUD) && !withinCompensation)
