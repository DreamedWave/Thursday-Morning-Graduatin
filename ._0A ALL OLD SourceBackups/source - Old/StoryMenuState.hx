...
class StoryMenuState extends MusicBeatState
{
	...
	static function weekData():Array<Dynamic>
	{
		return [
			...
			['Kid with a Gun', 'Playing With Fire', "Blammed"],
	...
	//Maiking this public for some stuff, do not ask i don't know how to code
	var curWeek:Int = 0;
	...
	override function create()
	{
		...
		if (FlxG.sound.music != null)
		{
			if (!FlxG.sound.music.playing)
			{
				...
				switch (FlxG.save.data.weekUnlocked)
				{
					...
					case 2:
						FlxG.sound.playMusic(Paths.music('glitchyMenu'), 1);
						bgColor = 0xFF120005;
						//TitleState.weekAdderThingy = "-glitchy";
					case 3:
						FlxG.sound.playMusic(Paths.music('cityMenu'), 1);
						bgColor = 0xFF0b0d1d;
						TitleState.weekAdderThingy = "-city";
					default:
						FlxG.sound.playMusic(Paths.music('peacefulMenu'), 1);
						bgColor = 0xFF0e1926;
				}
			}
		}
		...
		var yellowBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFFEB829C);
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			FlxG.sound.play(Paths.sound('confirmMenuLocked'));
	}
