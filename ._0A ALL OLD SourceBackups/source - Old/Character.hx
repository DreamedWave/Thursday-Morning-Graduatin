...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "guy-default", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-christmas':
				...
				animation.addByPrefix('singLEFT-alt', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'GF Right Note', 24, false);
				animation.addByPrefix('singUP-alt', 'GF Up Note', 24, false);
				animation.addByPrefix('singDOWN-alt', 'GF Down Note', 24, false);
			...
			case 'gf-pixel':
				...
				animation.addByIndices('cheer', 'GF CHEER', [0, 1, 2, 3, 4, 5, 6], "", 24, false);
			...
			case 'guy-default':
				var tex = Paths.getSparrowAtlas('guy_default','shared',true);
				frames = tex;
				...
				animation.addByPrefix('deathLoop', "GUY Dead Loop", 24, false);
			...
			case 'guy-fail':
				var tex = Paths.getSparrowAtlas('guy_Fail','shared',true);
				frames = tex;
			...
			case 'guy-theborder':
				var tex = Paths.getSparrowAtlas('guy_theBorder','shared',true);
				frames = tex;

				trace(tex.frames.length);

				animation.addByPrefix('idle', 'GUY idle dance', 24, false);
				animation.addByPrefix('singUP', 'GUY NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'GUY NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'GUY NOTE RIGHT0', 24, false);
				animation.addByPrefix('singDOWN', 'GUY NOTE DOWN0', 24, false);
				...
				animation.addByPrefix('awkward', 'GUY Awkward', 24, false);
			...
			case 'selfsert-default':
				...
				frames = tex;
				animation.addByPrefix('idle', 'DreamedWave idle dance', 24, false);
				animation.addByPrefix('singUP', 'DreamedWave NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'DreamedWave NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'DreamedWave NOTE RIGHT0', 24, false);
				animation.addByPrefix('singDOWN', 'DreamedWave NOTE DOWN0', 24, false);
				animation.addByPrefix('singUPmiss', 'DreamedWave NOTE UP MISS', 24, false);
				animation.addByPrefix('singLEFTmiss', 'DreamedWave NOTE LEFT MISS', 24, false);
				animation.addByPrefix('singRIGHTmiss', 'DreamedWave NOTE RIGHT MISS', 24, false);
				animation.addByPrefix('singDOWNmiss', 'DreamedWave NOTE DOWN MISS', 24, false);
				animation.addByPrefix('hey', 'DreamedWave HEY!!', 24, false);

				animation.addByPrefix('firstDeath', "DreamedWave dies", 24, false);
				animation.addByPrefix('deathLoop', "DreamedWave Dead Loop", 19, true);
				animation.addByPrefix('deathConfirm', "DreamedWave Dead confirm", 12, false);
		...
		if (isPlayer)
		{
			...
			if (!curCharacter.startsWith('guy'))
			{
				// var animArray
	...
	public function dance(forced:Bool = false)
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'table-default' | 'table-theborder' | 'gf-christmas' | 'gf-car' | 'gf-pixel':
