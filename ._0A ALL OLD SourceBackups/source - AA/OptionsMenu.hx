...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Performance and Caching", [
			...
			new HighQualityNoteSplash("Toggle antialiasing of the notesplash. (LOW increases performance, HIGH is more fancy.)"),
		...
		new OptionCategory("Saves and Data", [
			#if desktop
			new ShowPresenceOption("(NEEDS RESTART) Toggle showing Discord presence data in your status"),
		...
		if (acceptInput)
		{
			...
			if (isCat)
			{
				...
				else
				{
					...
					versionShit.text = "Offset (Left, Right, Shift for slow): " + HelperFunctions.truncateFloat(FlxG.save.data.offset,2) + "ms\nDescription: \n" + currentDescription;
				}
				if (currentSelectedCat.getOptions()[curSelected].getAccept())
