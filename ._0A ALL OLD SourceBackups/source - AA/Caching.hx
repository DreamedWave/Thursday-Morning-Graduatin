...
class Caching extends MusicBeatState
{
	...
	override function create()
	{
		...
		FlxG.sound.load(Paths.sound('disclaimerClick'));
		FlxG.sound.load(Paths.sound('disclaimerClickFlash'));
		FlxG.sound.load(Paths.sound('disclaimerClickFlashLaz'));
		FlxG.sound.load(Paths.sound('disclaimerSkip'));
