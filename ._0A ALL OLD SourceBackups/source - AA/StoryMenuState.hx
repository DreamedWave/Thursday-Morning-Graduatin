...
class StoryMenuState extends MusicBeatState
{
	...
	//Making this public for some stuff, do not ask i don't know how to code
	...
	override function create()
	{
		...
		var storyMenuColorBG:FlxSprite = new FlxSprite(0, 56).makeGraphic(FlxG.width, 400, 0xFFEB829C);
		...
		{
			var weekThing:MenuItem = new MenuItem(0, storyMenuColorBG.y + storyMenuColorBG.height + 10, i);
