...
class KadeEngineData
{
    public static function initSave()
    {
		...
		trace("Autopause is " + FlxG.save.data.showPresence);
		if (FlxG.save.data.pauseOnUnfocus == null)
			FlxG.save.data.pauseOnUnfocus == true;
		trace("NOW, Autopause is " + FlxG.save.data.showPresence);

		if (FlxG.save.data.cacheImages == null)
			FlxG.save.data.cacheImages = false;

		trace("Show Presence is " + FlxG.save.data.showPresence);
		if (FlxG.save.data.showPresence == null)
			FlxG.save.data.showPresence = true;
		trace("NOW, show Presence is " + FlxG.save.data.showPresence);

		if (FlxG.autoPause == true)
