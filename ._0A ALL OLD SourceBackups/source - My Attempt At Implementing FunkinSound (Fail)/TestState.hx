...
class TestState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		camGame.zoom = FlxMath.lerp(defaultCamZoom, camGame.zoom, PlayStateHelpers.calculateLerpTime(elapsed, 5 * (Conductor.bpm * 0.01), 0, 1));
		camHUD.zoom = FlxMath.lerp(1, camHUD.zoom, PlayStateHelpers.calculateLerpTime(elapsed, 5 * (Conductor.bpm * 0.01), 0, 1));
	}
