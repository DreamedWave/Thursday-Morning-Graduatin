...
class Controls extends FlxActionSet
{
	...
	var _style = new FlxActionDigital(Action.STYLE);
	...
	public var STYLE(get, never):Bool;

	inline function get_STYLE()
		return _style.check();
	...
	public function loadKeyBinds()
	{
		...
		buttons.set(Control.STYLE,[FlxGamepadInputID.RIGHT_TRIGGER]);
		...
		inline bindKeys(Control.STYLE, [FlxKey.fromString(FlxG.save.data.styleBind)]);
	}
