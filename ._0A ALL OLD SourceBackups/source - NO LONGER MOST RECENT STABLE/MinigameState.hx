...
class MinigameState extends MusicBeatState
{
	...
	override public function create()
	{
		FlxG.camera.zoom = 6;
		trace('mmm');
		map = new FlxOgmo3Loader('assets/data/zzz/minigame.ogmo', 'assets/data/zzz/room_0.json');
		trace("buh");
		walls = map.loadTilemap("assets/images/minigame/tilemap.png", "tiles");
		trace("bruh");
		walls.follow();
	...
	function toggleCamShake(toggle:Int = 0):Void
	{
		if (toggle == 1)
		{
