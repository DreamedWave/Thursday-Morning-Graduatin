...
class NoteSplashingEffectsOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Note Effects: " + (!FlxG.save.data.notesplash ? "on" : "off");
	}
}
...
class HighQualityNoteSplash extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Note FX Quality: " + (!FlxG.save.data.hqnotesploosh ? "low" : "high");
	}
}
...
class VideoCutscenes extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.video = !FlxG.save.data.video;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Video Cutscenes: " + (!FlxG.save.data.video ? "on" : "off");
	}
}
