...
class Note extends FlxSprite
{
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inCharter = false, noteStyle:String = 'normal')
	{
		super();
	...
	override function update(elapsed:Float)
	{
		...
		if (mustPress)
		{
			...
			if (strumTime < Conductor.songPosition - Conductor.safeZoneOffset * Conductor.timeScale && !wasGoodHit && noteStyle != "mine")
				tooLate = true;
			else if (strumTime - 95 < Conductor.songPosition - Conductor.safeZoneOffset * Conductor.timeScale && !wasGoodHit && noteStyle == "mine")
				tooLate = true;
		}
		else
		{
