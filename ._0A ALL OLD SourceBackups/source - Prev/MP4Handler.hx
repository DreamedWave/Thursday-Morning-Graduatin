...
class MP4Handler extends vlc.VlcBitmap
{
	...
	public function new(width:Float = 320, height:Float = 240, autoScale:Bool = true)
	{
		...
		DiscordClient.changePresence("In a Cutscene", null, null, true);
		#end
	...
	function update(e:Event)
	{
		...
		if (FlxG.sound.muted || FlxG.sound.volume <= 0.05)
			volume = 0;
		else
			volume = FlxG.sound.volume + 0.5;
	}
	 ...
	 */
	public function playVideo(path:String, ?repeat:Bool = false, pauseMusic:Bool = true)
	{
