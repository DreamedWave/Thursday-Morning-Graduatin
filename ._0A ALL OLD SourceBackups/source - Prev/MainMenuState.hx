...
//		magenta.color = 0xFFfd719b;
	...
	override function update(elapsed:Float)
	{
		...
		else if (optionShit[curSelected] == 'extras')
		{
			...
			{
				var mult1:Float = FlxMath.lerp(1, jumpscareSprite.scale.x, 0.875);
				var mult2:Float = FlxMath.lerp(7, jumpscareSprite.angle, PlayStateHelpers.LerpTime.calculate(elapsed * 2, 1, 0, 1));
