...
class FancyStageParticle extends FlxSprite
{
	...
	public function new(particleName:String, currentWeek:String, particlePercentage:Float = 1, min:Int, max:Int, x:Float, y:Float, color:FlxColor, nextColor:FlxColor)
	{
		super(x, y);
		...
		//if (color != nextColor)
		//	FlxTween.tween(this, {color: nextColor}, 1, {type: ONESHOT, ease: FlxEase.sineInOut, startDelay: 0.1});
	}
