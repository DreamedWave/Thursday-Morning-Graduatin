...
class LoadReplayState extends MusicBeatState
{
	...
	override function create()
	{
        ...
        addWeek(['Tech. Difficulties', 'Awkward Pauses', 'Up and Beyond'], 1, ['dad']);
        addWeek(['Desperation', 'Disagreement', 'Retaliation'], 2, ['priest-pray']);
        addWeek(['Kid with a Gun', 'Philly', 'Blammed'], 3, ['pico']);
		...
		versionShit = new FlxText(5, FlxG.height - 34, 0, "Replay Loader (ESCAPE TO GO BACK)\nNOTICE!!!! Replays are in a beta stage, and they are probably not 100% correct. Expect inaccuracies and literal crashes.\n", 12);
