...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_mute_inst = new FlxUICheckBox(10, 185, null, null, "Mute Instrumental (in editor)", 100);
		...
		var check_mute_miscs = new FlxUICheckBox(10, check_mute_inst.y + 20, null, null, "Mute Miscs (in editor)", 100);
...
*/
	...
	function loadJson(song:String):Void
	{
		...
		LoadingSubstate.loadAndSwitchState(new ChartingState());
	}
