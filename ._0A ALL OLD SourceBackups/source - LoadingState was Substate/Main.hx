...
class Main extends Sprite
{
	...
	function onWindowFocusOut()
	{
		...
		if (doFocusShit)
		{
			if (Type.getClass(FlxG.state) != PlayState && Type.getClass(FlxG.state) != ChartingState && (Type.getClass(FlxG.state) != FunnySplash || !FlxG.save.data.fullscreen)) // sorry i stole this from indie cross-
			{
				if (Type.getClass(FlxG.state) != FunnySplash && Type.getClass(FlxG.state) != Caching && Type.getClass(FlxG.state) != DisclaimerScreen)
	...
	function onWindowFocusIn()
	{
		if (doFocusShit)
		{
			if (Type.getClass(FlxG.state) != PlayState && Type.getClass(FlxG.state) != ChartingState && (Type.getClass(FlxG.state) != FunnySplash || !FlxG.save.data.fullscreen))
			{
				if (Type.getClass(FlxG.state) != FunnySplash && Type.getClass(FlxG.state) != Caching && Type.getClass(FlxG.state) != DisclaimerScreen)
