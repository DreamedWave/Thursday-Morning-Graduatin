...
class FunnySplash extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if (Main.curHourInt < 6 || Main.curHourInt > 23)
			Main.nightMode = true;
	...
	override function update(elapsed)
	{
		...
		if (FlxG.keys.justPressed.ANY && !FlxG.keys.justPressed.ZERO && !FlxG.keys.justPressed.PLUS && !FlxG.keys.justPressed.MINUS && !FlxG.keys.justPressed.ALT && !FlxG.keys.justPressed.TAB && !wentForTheMilk)
		{
			wentForTheMilk = true;
			finishSplash();
		}
