...
class PlayState extends MusicBeatState
{
	...
	var allowStyle:Bool = true; //temp until styleanim is implemmented
	...
	function styleOnEm(ms:Float):Void
	{
		...
		//Placeholder Anims - I'll add rating dependent ones in the future
		boyfriend.playAnim('hey', true);

		//Style bonus
		allowStyleBonus = true;

		if (allowStyleBonus && stylePresses <= 8)
		{
