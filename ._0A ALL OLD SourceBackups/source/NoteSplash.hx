	...
	public function new(x:Float = 0, y:Float = 0, ?note:Int = 0)
	{
		...
		switch (FlxG.save.data.notesfxType)
		{
			case "chill":
				...
				animation.addByPrefix('splash mine 0', 'mine note 1 splash', 24, false);
				animation.addByPrefix('splash mine 1', 'mine note 2 splash', 25, false);
				animation.addByPrefix('splash mine 2', 'mine note 3 splash', 26, false);
				animation.addByPrefix('splash trigger 0', 'trigger note 1 splash', 24, false);
				animation.addByPrefix('splash trigger 1', 'trigger note 2 splash', 25, false);
				animation.addByPrefix('splash trigger 2', 'trigger note 3 splash', 26, false);
			default:
