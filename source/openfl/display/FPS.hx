...
class FPS extends TextField
{
	...
	**/
	...
	//Whether the game is struggling or not - determines the lag comnpensation
	public var gameGoinThruIt:Bool = false;
	var defaultColor:FlxColor = 0xFF000000;
	...
	private #if !flash override #end function __enterFrame(deltaTime:Float):Void
	{
		...
		if (currentCount != cacheCount /*&& visible*/)
		{
			...
			{
				if (currentFPS < 120 && currentFPS <= FlxG.save.data.fpsCap / 2)
				{
