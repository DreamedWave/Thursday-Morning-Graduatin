...
class HitGraph extends Sprite
{
	...
	public function new(X:Float, Y:Float, Width:Int, Height:Int)
	{
		...
		var early = createTextField(10,_height - 30,FlxColor.WHITE,12);
	...
	function drawGraph():Void
	{
		...
		gfx.beginFill(0xB7E4B7);
		drawJudgementLine(45);
		gfx.endFill();

		gfx.beginFill(0xD1D1A0);
		drawJudgementLine(90);
		gfx.endFill();

		gfx.beginFill(0xB6A18F);
		drawJudgementLine(135);
		gfx.endFill();

		gfx.beginFill(0x887777);
		...
		for (i in 0...history.length)
		{
			...
			if (!PlayStateChangeables.botPlay)
			{
				...
				switch(judge)
				{
					...
					case "bad":
						gfx.beginFill(0xFFF000);
					case "shit":
						gfx.beginFill(0xff0000);
					case "miss":
						gfx.beginFill(0x475394);
					default:
	...
	public function fitX(x:Float)
	{
		...
		trace ('Song Time Be = ' + FlxStringUtil.formatTime(FlxG.sound.music.length / 1000, false));
	}
