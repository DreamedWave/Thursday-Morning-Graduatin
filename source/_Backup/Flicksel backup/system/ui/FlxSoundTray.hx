...
class FlxSoundTray extends Sprite
{
	...
	public var volumeUpSound:String = "flixel/sounds/volumeUp";

	/**The sound used when decreasing the volume.**/
	public var volumeDownSound:String = 'flixel/sounds/volumeDown';
	...
	public function update(MS:Float):Void
	{
		...
		if (FlxG.sound.volume > 0 && FlxG.sound.volume != 0 && !FlxG.sound.muted)
		{
			if (_timer > 0)
			{
				_timer -= MS / 1000;
	...
	public function show(up:Bool = false):Void
	{
		if (!silent)
		{
			...
			if (!FlxG.sound.muted && text.text != "0  MUTE  0")
				...
				sound = FlxAssets.getSound("flixel/sounds/volumeUnmute");
