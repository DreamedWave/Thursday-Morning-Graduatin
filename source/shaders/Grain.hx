...
class Grain extends FlxShader
{
	...
	*/
	@:glFragmentSource('
		...
		uniform float grainamount = 0.075;
		bool colored = true;
		uniform float coloramount = 0.6;
		uniform float grainsize = 2.5;
	...
	public function new(nSize:Float = 2.5, nTensity:Float = 0.075, nColAmt:Float = 0.6)
	{
		super();

		grainsize.value = [nSize];
		grainamount.value = [nTensity];
		coloramount.value = [nColAmt];
	}
}
