...
class FlxTextFormat
{
	 ...
	 */
	public function new(?Font:String, ?Size:Int = 8, ?FontColor:FlxColor, ?Bold:Bool, ?Italic:Bool, ?BorderColor:FlxColor)
	{
		format = new TextFormat(Font, Size, FontColor, Bold, Italic);
