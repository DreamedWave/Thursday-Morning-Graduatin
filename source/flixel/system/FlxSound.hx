...
class FlxSound extends FlxBasic
{
	 ...
	 */
	public function loadEmbedded(EmbeddedSound:FlxSoundAsset, Looped:Bool = false, AutoDestroy:Bool = true, ?OnComplete:Void->Void):FlxSound
	{
	 ...
	 * @return	This FlxSound instance (nice for chaining stuff together, if you're into that).
	 */
	public function loadStream(SoundURL:String, Looped:Bool = false, AutoDestroy:Bool = true, ?OnComplete:Void->Void, ?OnLoad:Void->Void):FlxSound
	{
		cleanup(true);
	 ...
	 * @return	This FlxSound instance (nice for chaining stuff together, if you're into that).
	 */
	public function loadByteArray(Bytes:ByteArray, Looped:Bool = false, AutoDestroy:Bool = true, ?OnComplete:Void->Void):FlxSound
	{
		cleanup(true);
	...
	function init(Looped:Bool = false, AutoDestroy:Bool = true, ?OnComplete:Void->Void):FlxSound
	{
		looped = Looped;
	...
	function set_pitch(v:Float):Float
	{
		...
		if (_channel != null)
		{
			@:privateAccess
			{
				lime.media.openal.AL.sourcef(_channel.__source.__backend.handle, lime.media.openal.AL.PITCH, v);
			}
		}
		#end
